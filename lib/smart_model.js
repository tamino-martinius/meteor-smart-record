...
SmartModel = class SmartModel {
  ...
  static get collections() {
    if (!_.isObject(SmartModel._collections)) {
      SmartModel._collections = {};
    }
    return SmartModel._collections;
  }
  ...
  /**
   * Defines the connection to the Meteor Server.
   *
   * @return {Object} Returns connection to Meteor server.
   */
